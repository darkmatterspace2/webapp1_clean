/**
 * Preset 1: General Research
 * Balanced, multi-engine research configuration with recency, doc types, and comprehensive media/image filters.
 */
...
export default {
  ...
  filters: [
    ...
    // -------------------------------------------------------------
    // Generic Image Search Filters (visible when in Images mode)
    // Engine parameter translation handled by engine-builders.js
    // -------------------------------------------------------------
    {
      id: "image-size",
      type: "select",
      ...
      options: [
        ...
        ["4mp", "4 MP (2272×1704)"],
        ["8mp", "8 MP (3264×2448)"],
        ["12mp", "12 MP (4000×3000)"],
        ["16mp", "16 MP (4928×3264)"],
        ["20mp", "20 MP (5120×3840)"],
        ["40mp", "40 MP (7360×4912)"],
        ["70mp", "70 MP+ (Ultra-high)"],
    ...
    // Video duration filter (visible in Videos mode)
    {
      id: "video-duration",
      type: "select",
  ...
  operators: [
    { id: "intitle", label: "intitle:", tip: "Term in page title", query: "intitle:" },
    { id: "inurl", label: "inurl:", tip: "Term in URL path", query: "inurl:" },
    { id: "intext", label: "intext:", tip: "Term in page text", query: "intext:" },
    { id: "or", label: "OR", tip: "Boolean alternative", query: "OR" },
    { id: "around", label: "AROUND(5)", tip: "Terms within 5 words of each other", query: "AROUND(5)" },
    { id: "exclude", label: "-exclude", tip: "Exclude keyword", query: "-" }
  ],
